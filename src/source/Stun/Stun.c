                           ...
                           PBYTE pBuffer, PUINT32 pSize)
{
    ...
    if (generateMessageIntegrity) {
        ...
        if (pBuffer != NULL) {
            ...
            CHK(NULL != HMAC(EVP_sha1(), password, (INT32) passwordLen, pBuffer, size, pCurrentBufferPosition + STUN_ATTRIBUTE_HEADER_LEN, &hmacLen),
    ...
    while (((PBYTE) pStunAttributeHeader < (PBYTE) pStunAttributes + pStunPacket->header.messageLength) && i < attributeCount) {
        ...
        switch (pDestAttribute->type) {
            ...
            case STUN_ATTRIBUTE_TYPE_MESSAGE_INTEGRITY:
                ...
                CHK(NULL !=
                        HMAC(EVP_sha1(), password, (INT32) passwordLen, pStunBuffer, size, pStunAttributeMessageIntegrity->messageIntegrity,
                             &hmacLen),
                    STATUS_INTERNAL_ERROR);
